...
/*
	 ...
	 *		Robot - Relies on strength to deal damage.  Also can use stored energy to
	 *		temporarily increase damage (max/starting energy equal to 2*magic).
...
public:
		...
		Fighter(string title, int hitPoints, int maxhitPoints, int strength, int speed, int maxspeed, int magic);
		~Fighter();
			/*
			 *	getName()
			 *
